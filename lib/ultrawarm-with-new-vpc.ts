...
export class UltraWarmDemoWithNewVPC extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const VPC_CIDR = "10.5.0.0/16";
    const DOMAIN_NAME = "es-demo";
    const ACCOUNT = UltraWarmDemoWithNewVPC.of(this).account;
    const REGION =  UltraWarmDemoWithNewVPC.of(this).region
